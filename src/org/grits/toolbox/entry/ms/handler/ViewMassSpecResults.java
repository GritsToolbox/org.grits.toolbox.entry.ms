...
/**
 * Opens MassSpec results
* @author D Brent Weatherly (dbrentw@uga.edu)
 *
 */
public class ViewMassSpecResults {
	
	public static final String COMMAND_ID = "org.grits.toolbox.entry.ms.handler.viewMassSpecResults";
	public static final String PARAMETER_ID = "viewSpecResults_Entry";

	//log4J Logger
	private static final Logger logger = Logger.getLogger(ViewMassSpecResults.class);
