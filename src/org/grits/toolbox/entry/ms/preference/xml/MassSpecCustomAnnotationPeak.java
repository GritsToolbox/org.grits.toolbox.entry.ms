...
/**
 * Class for description an individual MS Peak that should be annotated.
 * 
 * @author D Brent Weatherly (dbrentw@uga.edu)
 *
 */
@XmlRootElement(name = "massSpecCustomAnnotationPeak")
public class MassSpecCustomAnnotationPeak {
	private Double dPeakMz = null;
	private Integer iMSLevel = null;
	private String sPeakLabel = null;
	
	public MassSpecCustomAnnotationPeak() {
		// TODO Auto-generated constructor stub
	}
	
	@Override
	public boolean equals(Object obj) {
		if( ! (obj instanceof MassSpecCustomAnnotationPeak) ) {
			return false;
		}
		MassSpecCustomAnnotationPeak that = (MassSpecCustomAnnotationPeak) obj;
